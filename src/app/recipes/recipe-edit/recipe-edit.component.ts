...
export class RecipeEditComponent implements OnInit {
  id: number;
  editMode = false;
  recipeForm: FormGroup; // stores all form data
  ...
  onDeleteIngredient(index: number){
   (<FormArray>this.recipeForm.get('ingredients')).removeAt(index); // delete local control
   this.recipeService.deleteRecipeIngredient(this.id, index); // delete in service
  }
